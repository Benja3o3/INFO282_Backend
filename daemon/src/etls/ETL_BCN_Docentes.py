...
class ETL_Transactional:
    ...
    def Tranform(self, comunas, conflictNames):
        ...
        for _, comuna in comunas.iterrows():
            ...
            try:
                data = {
                    "total_docentes": comunaData[ comunaData[' Variable'] == " Total Docentes"].iloc[:, -1].values[0],
...
class ETL_Processing:
    def __init__(self, querys, localidades):
        ...
        self.nombreIndicadorA = "Densidad de docentes"
        self.indicador_idA = 17  ## Valor numerico, revisar si no existe en bd
        self.dimensionA = getDimension("Educacional")
        self.prioridadA = 1
        self.urlA =  "https://www.bcn.cl/siit/estadisticasterritoriales/tema?id=179"
        self.descripcionA = "Indicador que indica que tantos docentes hay segun la cantidad de poblacion de la comuna"
    ...
    def TransformA(self, comuna):
        ...
        df_merged.loc[:, 'valor'] =  df_merged['total_docentes'] / comuna['poblacion']
