...
class ETL_Transactional:
    def __init__(self, querys, localidades):
        ...
        self.fuente = "BCN_Tasa_de_denuncias_social"
    ...
    def Tranform(self, comunas, conflictNames):
        ...
        for _, comuna in comunas.iterrows():            
            ...
            try:            
                denuncias = comunaData[ comunaData[' Variable'] == " Tasa de Denuncias de DMCS"].iloc[:, -1].values[0]
                denuncias = (float(denuncias)/1000) * comuna['poblacion']
            except:
                denuncias = 0
         
            denuncias = comunaData.iloc[:, -1].values[0]
            
            data = {
                "cantidad_denuncias": float(denuncias),
...
class ETL_Processing:
    def __init__(self, querys, localidades):
        ...
        self.descripcionA = "Cantidad de denuncias por cada 1000 personas "
    ...
    def TransformA(self, comuna):
        ...
        df_merged.loc[:, 'valor'] = (df_merged['cantidad_denuncias'] / comuna['poblacion']) * 1000
